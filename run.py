...
lat_lon_label_3 = []  # List to store LAT/LON of label 3 points
...
for year in years:
    ...
    label_3_points = rule_df[rule_df['LABEL'] == 3][['LAT', 'LON']]
...
lat_lon_label_3_df.to_csv("lat_lon_label_3_points.csv", index=False)
